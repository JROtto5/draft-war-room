...
const projections=createRequire(import.meta.url)('../api/projections.js');
...
createServer(async(req,res)=>{
  try{
    ...
    const path=['/','/draft','/season'].includes(url.pathname)?'/index.html':decodeURIComponent(url.pathname);
