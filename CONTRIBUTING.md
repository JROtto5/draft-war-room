...
3. **Data comes from the pipeline.** Never hand-edit data.js — change tools/enrich.py and regenerate. Goldens (`tests/goldens.json`) guard the narrative outputs; rebless intentionally with UPDATE_GOLDENS=1.
