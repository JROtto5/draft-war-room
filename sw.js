...
self.addEventListener("fetch", e => {
  ...
  if (new URL(e.request.url).pathname==="/api/projections" || new URL(e.request.url).pathname.startsWith("/feeds/nfl/") || (!sameOrigin && !["image", "font", "style"].includes(e.request.destination))) {
